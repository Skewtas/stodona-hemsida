...
export default function KvalitetTrygghet() {
  return (
    <ContentPage
      ...
      answer={<>Stodona lämnar en <strong className="text-text-primary">nöjd-kund-garanti</strong>: är du inte nöjd kommer vi tillbaka och rättar till det utan extra kostnad. Vi är fullt <strong className="text-text-primary">ansvarsförsäkrade</strong> – skulle något mot förmodan gå sönder tar vår kundservice hand om ärendet och gör en bedömning tillsammans med försäkringen. Bakom företaget står Stodona AB (org.nr 559201-1059) i Solna, med 4,9/5 i snittbetyg.</>}
      facts={[
      ...
      sections={[
        ...
        },
        {
          ...
          body: <p>Stodona är fullt ansvarsförsäkrat. Skulle olyckan vara framme och något gå sönder under städningen hör du av dig till oss, så tar kundservice hand om ärendet och gör en bedömning tillsammans med försäkringen. Alla våra medarbetare är noggrant utvalda och arbetar under trygga anställningsvillkor.</p>,
        },
        {
      ...
      faq={[
        ...
        { q: "Är Stodona försäkrat?", a: "Ja, vi är fullt ansvarsförsäkrade. Går något sönder under städningen hör du av dig till kundservice, som tar hand om ärendet och gör en bedömning tillsammans med försäkringen." },
